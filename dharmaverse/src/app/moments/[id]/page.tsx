  ...
  return (
    <div className="min-h-screen bg-[#080B12] overflow-x-hidden">
      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 md:p-16 lg:px-24 pb-32 z-10">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <p className="text-primary tracking-[0.4em] uppercase text-sm font-bold mb-4 drop-shadow-md">Historical Record</p>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-16 lg:px-24 -mt-20 relative z-20">
        ...
        <section className="py-32 my-12 text-center rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden">
          <div className={`absolute inset-0 bg-gradient-to-br ${moment.theme} opacity-10 pointer-events-none`}></div>
          <div className="relative z-10 p-8">
            ...
            <Link href="/perspectives">
              <button className="bg-primary text-black px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:scale-105 transition-all shadow-[0_0_30px_rgba(212,175,55,0.4)]">
                Launch Perspective Engine
              </button>
            </Link>
          </div>
        </section>
